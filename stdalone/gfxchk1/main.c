...
#define BASE	((unsigned int *) 0xF4000000)
...
void main(void) {
  ...
  drawLine(0, 0, 639, 479, FOREGROUND);
  drawLine(0, 479, 639, 0, FOREGROUND);
  drawLine(0, 239, 639, 239, FOREGROUND);
  drawLine(0, 240, 639, 240, FOREGROUND);
  drawLine(319, 0, 319, 479, FOREGROUND);
  drawLine(320, 0, 320, 479, FOREGROUND);
  printf("\nHalting...\n");
}
