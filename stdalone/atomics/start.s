...
isr:
	...
	sub	$29,$29,128		; create exception frame
	stw	$2,$29,8		; save registers
	stw	$3,$29,12
	stw	$4,$29,16
	stw	$5,$29,20
	stw	$6,$29,24
	...
	stw	$24,$29,96
	stw	$25,$29,100
	stw	$26,$29,116		; this is the thread's sp
	stw	$27,$29,4		; this is the thread's $1
	stw	$30,$29,120		; this is the thread's resumption addr
	stw	$31,$29,124
	...
	ldw	$24,$29,96
	ldw	$25,$29,100
	ldw	$26,$29,116		; this is the thread's sp
	ldw	$27,$29,4		; this is the thread's $1
	ldw	$30,$29,120		; this is the thread's resumption addr
	ldw	$31,$29,124
	add	$1,$27,$0		; $27 -> $1
	add	$29,$26,0		; $26 -> sp
...
spinLock:
	...
	bne	$8,$0,spinLock
	; -----------------------------------------
	; artificially enlarge vulnerability window
	add	$8,$0,100
spinLock1:
	sub	$8,$8,1
	bne	$8,$0,spinLock1
