...
#define PXD_RCV_TYPE	(PXD_BASE + 1)		/* type register */
#define PXD_RCV_SIZE	(PXD_BASE + 2)		/* size register */
...
#define PXD_XMT_TYPE	(PXD_BASE + 5)		/* type register */
#define PXD_XMT_SIZE	(PXD_BASE + 6)		/* size register */
