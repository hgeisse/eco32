...
`define ST_ILLDA0	5'd11		// NOP, data_timeout=1, wait 2 cycles
...
`define ST_WRDATA3	5'd16		// NOP, ack=1, de=0, wait 2 cycles
`define ST_WRDATA4	5'd17		// NOP, ack=0, wait 2 cycles
...
`define ST_RDDATA4	5'd22		// NOP, ack=1, ld=0, wait 2 cycles
`define ST_RDDATA5	5'd23		// NOP, ack=0, wait 3 cycles
`define ST_ILLIA0	5'd24		// NOP, inst_timeout=1, wait 2 cycles
...
`define ST_RDINST4	5'd30		// NOP, ack=1, ld=0, wait 2 cycles
`define ST_RDINST5	5'd31		// NOP, ack=0, wait 3 cycles
...
module ramctrl(clk_ok, clk,
  ...
  always @(*) begin
    case (ram_cnt[1:0])
      2'b00:
        begin
          ram_dout[31:0] = data_din[127:96];
        end
      2'b01:
        begin
          ram_dout[31:0] = data_din[ 95:64];
        end
      2'b10:
        begin
          ram_dout[31:0] = data_din[ 63:32];
        end
      2'b11:
        begin
          ram_dout[31:0] = data_din[ 31: 0];
        end
    endcase
  end

  assign sdram_dq[31:0] = ram_de ? ram_dout[31:0] : 32'hzzzzzzzz;
