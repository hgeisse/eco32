...
void writeFinalModuleTable(void) {
  int mn;
...
void readObjHeader(EofHeader *objHeader,
  ...
  conv4FromEcoToNative((unsigned char *) &objHeader->olibs);
  conv4FromEcoToNative((unsigned char *) &objHeader->nlibs);
