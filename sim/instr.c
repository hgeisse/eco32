...
Instr instrTbl[] = {
  ...
  { "sqrt",  FORMAT_XRR1, OP_FAR1, XOP_SQRT, NULL },
  { "cif",   FORMAT_XRR1, OP_FAR1, XOP_CIF,  NULL },
  { "cfir",  FORMAT_XRR1, OP_FAR1, XOP_CFIR, NULL },
  ...
  { "absf",  FORMAT_XRR1, OP_FAR1, XOP_ABSF, NULL },
  { "eqf",   FORMAT_XRR2, OP_FCMP, XOP_EQF,  NULL },
  { "nef",   FORMAT_XRR2, OP_FCMP, XOP_NEF,  NULL },
  { "lef",   FORMAT_XRR2, OP_FCMP, XOP_LEF,  NULL },
  { "ltf",   FORMAT_XRR2, OP_FCMP, XOP_LTF,  NULL },
  { "ulef",  FORMAT_XRR2, OP_FCMP, XOP_ULEF, NULL },
  { "ultf",  FORMAT_XRR2, OP_FCMP, XOP_ULTF, NULL },
