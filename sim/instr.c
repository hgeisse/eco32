...
Instr instrTbl[] = {
  ...
  { "bfpf",  FORMAT_J,    OP_BFPF, 0,        NULL },
  { "bfpt",  FORMAT_J,    OP_BFPT, 0,        NULL },
  ...
  { "addf",  FORMAT_XRRR, OP_FAR2, XOP_ADDF, NULL },
  { "subf",  FORMAT_XRRR, OP_FAR2, XOP_SUBF, NULL },
  { "mulf",  FORMAT_XRRR, OP_FAR2, XOP_MULF, NULL },
  { "divf",  FORMAT_XRRR, OP_FAR2, XOP_DIVF, NULL },
  { "sqrt",  FORMAT_XRR,  OP_FAR1, XOP_SQRT, NULL },
  { "cif",   FORMAT_XRR,  OP_FAR1, XOP_CIF,  NULL },
  { "cfir",  FORMAT_XRR,  OP_FAR1, XOP_CFIR, NULL },
  { "cfit",  FORMAT_XRR,  OP_FAR1, XOP_CFIT, NULL },
  { "cfif",  FORMAT_XRR,  OP_FAR1, XOP_CFIF, NULL },
  { "cfic",  FORMAT_XRR,  OP_FAR1, XOP_CFIC, NULL },
  { "eqf",   FORMAT_XRR,  OP_FCMP, XOP_EQF,  NULL },
  { "nef",   FORMAT_XRR,  OP_FCMP, XOP_NEF,  NULL },
  { "lef",   FORMAT_XRR,  OP_FCMP, XOP_LEF,  NULL },
  { "ltf",   FORMAT_XRR,  OP_FCMP, XOP_LTF,  NULL },
  { "ulef",  FORMAT_XRR,  OP_FCMP, XOP_ULEF, NULL },
  { "ultf",  FORMAT_XRR,  OP_FCMP, XOP_ULTF, NULL },
