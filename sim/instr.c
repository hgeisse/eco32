...
Instr instrTbl[] = {
  ...
  { "fadd",  FORMAT_XRRR, OP_FPAR, XOP_FADD, NULL },
  { "fsub",  FORMAT_XRRR, OP_FPAR, XOP_FSUB, NULL },
  { "fmul",  FORMAT_XRRR, OP_FPAR, XOP_FMUL, NULL },
  { "fdiv",  FORMAT_XRRR, OP_FPAR, XOP_FDIV, NULL },
